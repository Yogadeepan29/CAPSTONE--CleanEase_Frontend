      ...
      <Carousel pauseOnHover>
        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-blue-900 dark:text-blue-300">
...
>
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    <div className="max-w-screen-md mb-8 lg:mb-16">
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-blue-800 dark:text-blue-500">"Why Choose Our Cleaning Services?"</h2>
    ...
    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0 text-center">
      <div>
        <div className="flex justify-center items-center mb-4 w-full h-16 rounded-full bg-primary-100 lg:h-20  dark:bg-primary-900">
          <FaUserTie className="feature-icon text-3xl text-blue-500" />
        </div>
      ...
      <div>
        <div className="flex justify-center items-center mb-4 w-full h-16 rounded-full bg-primary-100 lg:h-20  dark:bg-primary-900">
          <FaClock className="feature-icon text-3xl text-green-500" />
        </div>
      ...
      <div>
        <div className="flex justify-center items-center mb-4 w-full h-16 rounded-full bg-primary-100 lg:h-20  dark:bg-primary-900">
          <FaLeaf className="feature-icon text-3xl text-green-700" />
        </div>
      ...
      <div>
        <div className="flex justify-center items-center mb-4 w-full h-16 rounded-full bg-primary-100 lg:h-20  dark:bg-primary-900">
          <FaLock className="feature-icon text-3xl text-red-500" />
        </div>
      ...
      <div>
        <div className="flex justify-center items-center mb-4 w-full h-16 rounded-full bg-primary-100 lg:h-20  dark:bg-primary-900">
          <FaSmile className="feature-icon text-3xl text-yellow-500" />
        </div>
      ...
      <div>
        <div className="flex justify-center items-center mb-4 w-full h-16 rounded-full bg-primary-100 lg:h-20  dark:bg-primary-900">
          <FaThumbsUp className="feature-icon text-3xl text-purple-500" />
        </div>
...
<section id="content" className="bg-white dark:bg-gray-900">
  <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
    <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400 ">
      <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-green-700 dark:text-green-500">Cleaning Your Home, One Surface at a Time</h2>
...
<section id="testimonial" className="bg-gray-100 dark:bg-gray-900">
  <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-8 lg:pt-12">
    <figure className="max-w-screen-md mx-auto">
      <svg className="h-12 mx -auto mb-3 text-green-400 dark:text-green-600" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <figcaption className="flex items-center justify-center mt-6 space-x-3">
        ...
        <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
          ...
          <div className="pl-3 text-sm font-bold text-gray-500 dark:text-gray-400">Loyal Customer</div>
        </div>
      </figcaption>
    </figure>
  </div>
...
<section id="faq" className="bg-white dark:bg-gray-900 mb-10 pt-20">
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-blue-800 dark:text-blue-500">Frequently asked questions</h2>
    <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
      <div>
        <div className="mb-10">
          <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
            <svg className="flex-shrink-0 mr-2 w-5 h-5 text-yellow-500 dark:text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" /></svg>
